...
class MailTemplate(models.Model):
    ...
    category = models.ForeignKey(
        ...
        verbose_name=_('Category'), default=DEFAULT_CATEGORY, on_delete=models.SET_NULL)
    base = models.ForeignKey(
        MailBaseTemplate, null=True, blank=True,
        verbose_name=_('Basic template'), on_delete=models.SET_NULL)
    created = models.DateTimeField(_('Created'), auto_now_add=True)
    updated = models.DateTimeField(_('Updated'), auto_now=True)
...
class MailFile(models.Model):
    template = models.ForeignKey(
        MailTemplate, verbose_name=_('Template'), related_name='files', on_delete=models.CASCADE)
    name = models.CharField(_('Name'), max_length=100)
...
class MailLog(models.Model):
    ...
    error_exception = models.ForeignKey(
        MailLogException, null=True, blank=True, verbose_name=_('Exception'), on_delete=models.SET_NULL)
    num_of_retries = models.PositiveIntegerField(
        _('Number of retries'), default=1)
...
class MailGroupEmail(models.Model):
    ...
    group = models.ForeignKey(
        MailGroup, verbose_name=_('Group'), related_name='emails', on_delete=models.CASCADE)
...
class Signal(models.Model):
    ...
    model = models.ForeignKey(
        'contenttypes.ContentType', verbose_name=_('Model'), on_delete=models.CASCADE)
    ...
    group = models.ForeignKey(
        ...
        help_text=_('You can use group email or rules for recipients.'), on_delete=models.SET_NULL)
...
class MailLogTrack(models.Model):
    mail_log = models.ForeignKey(MailLog, verbose_name=_('Log'), on_delete=models.CASCADE)
...
class MailSubscriptionAbstract(models.Model):
    ...
    user = models.ForeignKey(
        AUTH_USER_MODEL, verbose_name=_('User'), null=True, blank=True, on_delete=models.SET_NULL)
    backend = models.CharField(
